...
function FormCheckout({onCheckout}){
    ...
    return(
        ...
        <h3 className="form-title">Ingrese sus datos para completar la compra</h3>
          <div>
            <label className="input-form">Nombre</label>
            <input value={userData.nombre} name="nombre" type="text" placeholder="Nombre" required onChange={onInputChange} />
          </div>
          <div>
            <label className="input-form">Apellido</label>
            <input value={userData.apellido} name="apellido" type="text" placeholder="Apellido" required onChange={onInputChange} />
          </div>
          <div>
            <label className="input-form">Email</label>
            <input value={userData.email} name="email" type="email" placeholder="Email" required onChange={onInputChange} />
          </div>
          <div>
            <label className="input-form">Teléfono</label>
            <input value={userData.telefono} name="telefono" type="number" placeholder="Telefono" required onChange={onInputChange} />
          </div>
          <div>
