...
export default function ItemCount({onAddToCart}) {
  ...
  return (
    <div>
      ...
      <button onClick={hadleSubstract} disabled={count === 1} className="btn-count"> 
       <strong> - </strong> 
        </button>
        ...
        <Link to="/cart"><button onClick={() => onAddToCart(count)} className="btn-agregar-carrito">Agregar al carrito</button></Link>
    </div>
  );
}
